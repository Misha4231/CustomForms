                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown" v-if="signedIn">
                            <div class="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img :src="profileStore.avatar ? (profileStore.avatar.startsWith('blob') ? profileStore.avatar : mediaHost + profileStore.avatar) : '/user.png'" class="rounded-circle" width="30" height="30" alt="avatar">
                            </div>
